    ...
    <div className="relative min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 px-4 pt-32 pb-12 transition-colors duration-300 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col gap-16">
        <section className="relative opacity-0 animate-fadeInUp">
          <div className="bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-8 shadow-sm flex flex-col gap-8 text-base md:text-lg">
            <div>
              <a
                href={previousPage}
                ...
                data-track="click:back_to_previous"
              >
                ← Back to Previous
              </a>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div
                className="w-64 h-64 sm:w-72 sm:h-72 md:w-96 md:h-96 mx-auto rounded-lg border border-gray-300 dark:border-gray-700 shadow-sm flex items-center justify-center bg-white dark:bg-gray-950"
